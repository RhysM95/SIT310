...
class RobotVisualiser(Node):
    ...
    def __init__(self):
        ...
        request.name = 'wall'
        request.xml = "<?xml version='1.0'?><sdf version='1.4'><model name='my_model'><pose>5 0.5 0 0 0</pose><static>true</static><link name='link'><collision name='collision'><geometry><box><size>0.25 3 3</size></box></geometry></collision><visual name='visual'><geometry><box><size>0.25 3 3</size></box></geometry></visual></link></model></sdf>"        
